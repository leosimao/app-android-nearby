package com.deveasy.nearby.ui.theme.component.button
        ...
        Row (
            ...
            iconRes?.let {
                Icon(
                    ...
                    contentDescription = "Icone do botão de confirmar"
                )
            }
...
private fun NearbyButtonNoTextPreview() {
    NearbyButton(modifier = Modifier.fillMaxWidth(), iconRes = R.drawable.ic_arrow_left) {
